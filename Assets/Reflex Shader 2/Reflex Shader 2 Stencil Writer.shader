...
Shader "Reflex Shader 2/Stencil/Writer"
{
	...
	SubShader
	{
		...
		void outlineSurf( Input i, inout SurfaceOutput o )
		{
			...
			float4 lerpResult745_g81 = lerp( DiffuseBase606_g81 , temp_cast_1 , _GrayscaleColor);
			...
			float4 clampResult650_g81 = clamp( ( float4( localFunction_ShadeSH9411_g81 , 0.0 ) + ifLocalVar196_g81 ) , temp_cast_6 , float4( 1,1,1,1 ) );
			float4 temp_cast_7 = (1.0).xxxx;
			float4 lerpResult723_g81 = lerp( saturate( clampResult650_g81 ) , temp_cast_7 , _Unlit);
			...
			float lerpResult726_g81 = lerp( temp_output_335_0_g81 , saturate( ( temp_output_335_0_g81 * 1 ) ) , _ObjectShadow);
			...
			float4 temp_cast_12 = (temp_output_351_0_g81).xxxx;
			float4 temp_cast_14 = (temp_output_351_0_g81).xxxx;
			float div354_g81=256.0/float((int)255.0);
			float4 posterize354_g81 = ( floor( temp_cast_14 * div354_g81 ) / div354_g81 );
			float4 lerpResult720_g81 = lerp( temp_cast_12 , posterize354_g81 , _PosterizeToggle);
			float4 temp_cast_15 = (0.0).xxxx;
			float4 temp_cast_16 = (1.0).xxxx;
			float4 clampResult364_g81 = clamp( lerpResult720_g81 , temp_cast_15 , temp_cast_16 );
			...
			float4 temp_cast_17 = (temp_output_353_0_g81).xxxx;
			float4 temp_cast_19 = (temp_output_353_0_g81).xxxx;
			float div356_g81=256.0/float((int)255.0);
			float4 posterize356_g81 = ( floor( temp_cast_19 * div356_g81 ) / div356_g81 );
			float4 lerpResult721_g81 = lerp( temp_cast_17 , posterize356_g81 , _PosterizeToggle);
			float4 temp_cast_20 = (0.0).xxxx;
			float4 temp_cast_21 = (1.0).xxxx;
			float4 clampResult363_g81 = clamp( lerpResult721_g81 , temp_cast_20 , temp_cast_21 );
			...
			float4 lerpResult735_g81 = lerp( temp_cast_8 , lerpResult372_g81 , _HalfLambertToggle);
			...
			o.Emission = ( ( float4( ( (Diffuse105_g81).rgb * appendResult387_g81 ) , 0.0 ) * Lighting201_g81 * Shadow375_g81 ) + Emission679_g81 ).rgb;
...
/*ASEBEGIN
Version=17000
1927;18;1906;1014;909.546;305.4102;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;238;-581.649,143.5963;Float;False;Reflex Shader Function;0;;81;f5d8f584674c8984ab029c8868eb5bf3;0;0;6;COLOR;186;FLOAT;265;COLOR;0;COLOR;402;FLOAT;403;COLOR;404
...
Node;AmplifyShaderEditor.RangedFloatNode;219;469.1616,-203.5059;Float;False;Property;_StencilReadMask;Stencil Read Mask;81;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;150,-18;Float;False;True;2;Float;RSInspector;0;0;CustomLighting;Reflex Shader 2/Stencil/Writer;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Masked;0.5;True;True;0;False;TransparentCutout;;AlphaTest;ForwardOnly;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;True;2;True;218;255;False;219;255;False;220;7;False;221;3;False;222;0;False;223;0;False;224;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;1;False;-1;1;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;82;-1;-1;-1;0;False;0;0;True;48;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=A79B8CC9DEF0A2ABCFAD67ABBE01D0358C39270D